...
In this task, you will create an Azure resource in the Azure portal, select the OpenAI service, and configure settings such as region and pricing tier. This setup allows you to integrate OpenAI's advanced language models into your applications.

1. In the **Azure portal**, search for **OpenAI** and select **Azure OpenAI**.

   ![](../media/tel-11.png)

2. On the **Azure AI Services | Azure OpenAI** blade, click on **+Create**.
...
4. Choose **Next (6)** by keeping everything else as default and click on **Create**.
...
In this task, you will deploy a specific AI model instance within your Azure OpenAI resource to integrate advanced language capabilities into your applications.
...
5. From the left navigation pane, select **Deployments (1)** and click on **+ Deploy model**. Choose **Deploy Base Model (2)**.

      ![](../media/ui1.png "Create a new deployment")

6. Search for **gpt-35-turbo** and click on **Confirm**.
...
In this task, you will explore a model in the Completions playground that involves interacting with the AI model to test and refine its responses using real-time input and output examples.
...
3. Select the **+ Add section (3)** box and click on **Examples (4)**. Enter the following message and response in the designated boxes:
...
In this task, you will explore code generation by testing the AI model’s ability to generate and suggest code snippets based on various programming prompts and requirements.
